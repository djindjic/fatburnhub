...
gulp.task('images', function() {
  return gulp.src(['app/shared/images/*'], {base: './app/shared/images'})
...
gulp.task('default', ['connect', 'watch', 'vendor-scripts', 'vendor-fonts', 'vendor-styles', 'scripts', 'styles', 'images', 'fonts', 'html', 'templates']);